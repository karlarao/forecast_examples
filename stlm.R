...
# stlm
mod_stl = stlm(train.ts)
mod_stl.pred = forecast(mod_stl, h = nValid)
...
### STLM 
plot(mod_stl.pred, ylim = c(1300, 2600),  ylab = "Ridership", xlab = "Time", bty = "l", xaxt = "n", xlim = c(1991,2006.25), main = "", flty = 2)
axis(1, at = seq(1991, 2006, 1), labels = format(seq(1991, 2006, 1)))
lines(mod_stl.pred$fitted, lwd = 2, col = "red")
lines(valid.ts)
