...
nValid <- 36    # set to 36 or 50 months, or negative number for future forecast
...
ma.centered <- ma(train.ts, order = 12)

### Time Series Linear Regression
train.lm.trig <- tslm(ma.trailing ~ trend + I(trend^2) + I(sin(2*pi*trend/1)) + I(cos(2*pi*trend/1)))
